import { defineComponent, computed as computed$1, openBlock, createElementBlock, normalizeClass as normalizeClass$1, createCommentVNode, renderSlot, resolveComponent, createBlock, withCtx as withCtx$1, createTextVNode as createTextVNode$1 } from 'vue';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("button", {
    class: normalizeClass$1(_ctx.classs),
...
const _hoisted_1 = /*#__PURE__*/createTextVNode$1("按钮");

function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_icon = resolveComponent("icon", true);
